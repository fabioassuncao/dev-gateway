...
import { RunnerStatus } from '../../shared/types.ts'
import { runnerStatus } from '../core/runner.ts'
...
export function runnerRoutes(deps: AppDeps): Hono {
  ...
  app.get('/runner', documentRoute({
    tag: 'Projects', operationId: 'getRunnerStatus', summary: 'Get the project-runner state',
