...
`TS_DEST_IP`. This composes beautifully — Traefik never changes shape — but
...
This path is **not covered by automated end-to-end tests** — it needs a real
tailnet and a real VPS. Configuration tests assert that the profile renders and
