...
See [configuration](../../product/reference/configuration.md), [persistence](../../product/concepts/persistence.md), and
[the audit](../../product/reference/configuration.md) for consumers and validation.
