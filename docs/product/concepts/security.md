...
status ([ADR 0011](../../development/adr/0011-panel-reads-traefik-writes-one-file.md)). Nothing
...
See [ADR 0035](../../development/adr/0035-authentication-lives-in-the-panel.md).
...
- **Traefik configuration.** The panel may write four filenames in
  ...
  See [ADR 0011](../../development/adr/0011-panel-reads-traefik-writes-one-file.md).
