...
[ADR 0023](adr/0023-flat-hostname-labels.md).
...
supported; see [ADR 0025](adr/0025-cloudflare-tunnel.md) for the comparison.
...
([tailscale.md](tailscale.md)) or publish a port directly.

## See also

- [ADR 0025](adr/0025-cloudflare-tunnel.md) — the architecture, and what was
  measured to arrive at it
- [ADR 0023](adr/0023-flat-hostname-labels.md) — why hostnames are one label
- [cloudflare.md](cloudflare.md) — Cloudflare as a DNS provider, for certificates
- [security.md](security.md) — what each exposure level means
